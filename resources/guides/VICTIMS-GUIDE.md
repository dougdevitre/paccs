...
```mermaid
flowchart LR
    A["1. DOCUMENTATION<br/>Incident logs<br/>Communication records<br/>Evidence inventory"] 
    --> B["2. PROFESSIONALS<br/>Attorney who gets alienation<br/>Therapist for you<br/>Evaluator if needed"]
    --> C["3. SUPPORT<br/>Support group<br/>Trusted family/friends<br/>PACCS resources"]
    --> D["4. RESILIENCE<br/>Self-care plan<br/>Long-term perspective<br/>Never give up"]
...
```mermaid
flowchart TB
    S1["SHOCK<br/><i>'This can't be happening'</i>"]
    S2["DENIAL<br/><i>'It will get better on its own'</i>"]
    S3["ANGER<br/><i>'How can they do this to our child?'</i>"]
    S4["BARGAINING<br/><i>'If I just try harder / give more...'</i>"]
    S5["DEPRESSION<br/><i>'I've lost everything'</i>"]
    S6["ACCEPTANCE<br/><i>'This is a marathon, not a sprint'</i>"]
    S7["ACTION<br/><i>'I will fight strategically and<br/>take care of myself'</i>"]

    S1 --> S2 --> S3 --> S4 --> S5 --> S6 --> S7
    S3 -.->|"May cycle<br/>back"| S5
    S5 -.->|"May cycle<br/>back"| S3
    ...
    style S7 fill:#c8e6c9,stroke:#1b5e20,stroke-width:2px
```
